        ...
        <table>
            ...
            <tbody>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right">{{ $totalKurir }} kunjungan</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="summary-section">
        ...
        <table style="width: 300px; margin-bottom: 0;">
            <tr>
                ...
                <td style="border: none; padding: 5px 0;" class="text-right font-bold">{{ count($dailyCount) }} hari</td>
            </tr>
            <tr>
                <td style="border: none; padding: 5px 0;">Total Kunjungan:</td>
                <td style="border: none; padding: 5px 0;" class="text-right font-bold">{{ $totalKurir }} kunjungan</td>
            </tr>
        </table>
    </div>
