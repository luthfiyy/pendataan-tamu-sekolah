...
<nav class="sidebar">
    ...
    <div class="menu-bar">
        <div class="menu">
            <div class="menu-head small text-uppercase">
            ...
            <ul class="menu-links" style="padding-left: 0;">
                ...
                <li class="nav-link {{ request()->routeIs('FO.dashboard') ? 'active' : '' }}">
                    <a href="{{ route('FO.dashboard') }}">
                        <i class='bx bx-home-alt icon'></i>
                        <span class="text nav-text">Beranda</span>
                    </a>
                </li>
                <li class="nav-link {{ request()->routeIs('FO.pegawai') ? 'active' : '' }}">
                    <a href="{{ route('FO.pegawai') }}">
                        <i class='bx bx-user icon'></i>
                        <span class="text nav-text">Pegawai</span>
                    </a>
                </li>
                <li class="nav-link {{ request()->routeIs('FO.laporan-tamu') ? 'active' : '' }}">
                    <a href="{{ route('FO.laporan-tamu') }}">
                        <i class='bx bx-file icon'></i>
                        <span class="text nav-text">Laporan Tamu</span>
                    </a>
                </li>
                <li class="nav-link {{ request()->routeIs('FO.laporan-kurir') ? 'active' : '' }}">
