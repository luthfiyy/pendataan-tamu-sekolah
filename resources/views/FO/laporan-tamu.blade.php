        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="table-container">
                    <div class="card my-4 custom-width">
                        ...
                        <div class="card-body px-0 pb-2">
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="laporanTable">
                                    <thead>
                                        <tr>
                                            <th class="text-center text-sm font-weight-bolder">
                                                Nama & Email</th>
                                            <th class="text-center text-sm font-weight-bolder">
                                                Alamat</th>
                                            <th class="text-center text-sm font-weight-bolder">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    @if ($kedatanganTamu->status === 'Diterima')
                                                        <span class="bg-gradient-success">{{ $kedatanganTamu->status }}</span>
                                                    @elseif ($kedatanganTamu->status === 'Ditolak')
                                                        <span class="bg-gradient-danger">{{ $kedatanganTamu->status }}</span>
                                                    @else
