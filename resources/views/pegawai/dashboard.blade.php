                            ...
                            <div class="card accordion-item">
                                ...
                                <div id="accordionOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        @if ($tamuTerbaru->isEmpty())
                                            <p class="p-4 text-center text-sm">Tidak ada tamu</p>
                                        @else
                                                    ...
                                                    <div class="card-body p-2" style="background-color: #fff">
                                                        <div class="preview-tamu d-flex align-items-center p-3"
                                                            ...
                                                            <div class="p-2">
                                                                ...
                                                                <span
                                                                    class="font-weight-bold text-xs">Waktu perjanjian: {{ $tamu->created_at->translatedFormat('l d-m-Y, H:i:s') }}</span>
                            ...
                            <div class="card accordion-item mb-4">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button type="button" class="accordion-button collapsed"
                                        ...
                                        <h6 class="m-3 w-60" style="color: #191919">Daftar Kunjungan Kurir Terbaru
                                        </h6>
                                    </button>
                                </h2>
                                <div id="accordionTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        @if ($kurirTerbaru->isEmpty())
                                            <p class=" p-4 text-center text-sm">Tidak ada Kurir</p>
                                        @else
                                                        ...
                                                        <div class="preview-tamu d-flex align-items-center p-3"
                                                            ...
                                                            <div class="p-2">
                                                                <span class="font-weight-bold text-xs">Waktu
                                                                    kedatangan: {{ $kurir->created_at->translatedFormat('l d-m-Y, H:i:s') }}</span>
                                                                <p class="text-sm font-weight-bold mb-0 ml-2">
