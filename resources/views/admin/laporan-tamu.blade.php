...
<body style="overflow-x:hidden;">
                            ...
                            <table class="table align-items-center mb-0" id="laporanTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-xs font-weight-bolder">Informasi Tamu
                                        </th>
                                        ...
                                        <th class="text-center text-uppercase text-xs font-weight-bolder ">Detail</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($tamus as $index => $kedatanganTamu)
                                        <tr>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <h6 class="mb-0 text-sm font-weight-bold">
                                                            {{ ucwords(strtolower($kedatanganTamu->tamu->nama))}}</h6>
                                                        {{-- <span
                                                                class="text-xs font-weight-bold mb-0">{{ $kedatanganTamu->tamu->no_telp }}</span> --}}
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                @else
                                                    <span class="bg-gradient-dark">{{ $kedatanganTamu->status }}</span>
                                                @endif
                                            </td>
                                            {{-- <td class="align-middle text-center">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tamuDetailModal.addEventListener('hidden.bs.modal', function() {
